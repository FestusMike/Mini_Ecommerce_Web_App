...
def create_advert():
    ...
    if form.validate_on_submit():
        ...
        msg.html = f"""<p>Hello {current_user.username}, Congratulations, Your Advert has been Succesfully Placed on the Market. Please be informed that your commodity might be taken down if any fraudulent activity is discovered.
                        Kindly note that this is a virtually generated e-mail address and we can\'t be contacted through this medium. To message us, send us
                        an email on festusmike30@yahoo.com. Thank You.</p>"""
        # Send the email
        mail.send(msg)
